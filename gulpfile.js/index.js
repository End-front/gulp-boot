...
function watchFile(cb) {
  ...
  watch([path.file.scssModule, path.file.scss, '!' + path.file.bootstrapModule, '!' + path.file.bootstrap], series(myScss.scss, myCore.reloadBrowser)),
  watch([path.file.bootstrapModule, path.file.bootstrap], series(myScss.bootstrap, myCore.reloadBrowser))
...
exports.bootstrap = myScss.bootstrap;
...
exports.allTask = series( myImage.cleanImage, parallel(myHtml.html, myScss.scss, myScss.bootstrap, myJs.script, myImage.image, myFonts.fonts) );
